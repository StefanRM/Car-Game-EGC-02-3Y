...
{
	modelMatrix = visMatrix * Transform2D::Translate(distX + 0, distY + 0);
	RenderMesh2D(meshes["square1"], shaders["VertexColor"], modelMatrix);

	modelMatrix = visMatrix * Transform2D::Translate(distX + 3, distY + 0);
	RenderMesh2D(meshes["square1"], shaders["VertexColor"], modelMatrix);

	modelMatrix = visMatrix * Transform2D::Translate(distX + 1.5, distY + 1.5);
	RenderMesh2D(meshes["square1"], shaders["VertexColor"], modelMatrix);

	modelMatrix = visMatrix * Transform2D::Translate(distX + 0, distY + 3);
	RenderMesh2D(meshes["square1"], shaders["VertexColor"], modelMatrix);

	modelMatrix = visMatrix * Transform2D::Translate(distX + 3, distY + 3);
	RenderMesh2D(meshes["square1"], shaders["VertexColor"], modelMatrix);
}
